...
<div id="curso" class="row">
                ...
                <tr>
                    ...
                    <td class="text-center text-secondary">
                        <form action="{{ route('course.ver') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-link p-0 @unless ($subscribed) disabled @endunless {{ $course->premium ? 'text-info' : '' }}">
                                <i class="fa
                                        fa-volume-up" aria-hidden="true"></i>
                            </button>
                        </form>
                    </td>
                    <td class="text-center text-secondary">
    ...
    <aside class="col-6 pl-3">
        <div style="background-image: url({{ get_course_image_path($course->id) }});
    ...
    <div class="mt-5">
        ...
        <div class="row">
            @forelse ($course->cursos_recomendados as $recommendedCourse)
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{route('ver-curso', [$recommendedCourse->id => str_replace(' ', '_', $recommendedCourse->title)]) }}" class="btn btn-sm btn-outline-secondary">View</a>
                            </div>
